document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function createError(message) {
      ...
      span.style.cssText = 'display:block;color:#e53e3e;font-size:0.85em;margin-top:4px;';
    ...
    function validateField(field) {
      ...
      if (field.tagName === 'TEXTAREA' && field.hasAttribute('required') && value.length < 10) {
        showError(field, field.dataset.errorMinlength || 'Please provide more detail (at least 10 characters).');
        return false;
      }
  ...
  const animatedElements = document.querySelectorAll(
    '.fade-in, .animate-on-scroll, [data-animate], .section, section > .container'
  );
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "YAEL GRAPHIC DESIGN STUDIO משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '39b7282e-46ae-45c5-8e1f-45d5706709dd',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '39b7282e-46ae-45c5-8e1f-45d5706709dd';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '39b7282e-46ae-45c5-8e1f-45d5706709dd';
